...
const tuiles: Tuile[] = [
  { label: "entraînement collectif", cat: "Entraînement", classe: "flex-[2_1_520px] h-[320px] lg:h-[400px]" },
  { label: "groupe", cat: "Groupe", classe: "flex-[1_1_260px] h-[190px]" },
  { label: "compétition", cat: "Compétition", classe: "flex-[1_1_260px] h-[190px]" },
  { label: "stage", cat: "Stage", classe: "flex-[1_1_240px] h-[240px]" },
  { label: "démonstration", cat: "Démonstration", classe: "flex-[1_1_240px] h-[240px]" },
  { label: "événement associatif", cat: "Événement", classe: "flex-[2_1_380px] h-[240px]" },
];
    ...
    <section id="galerie" className="bg-white py-20 lg:py-30">
      <div className="mx-auto max-w-[1360px] px-7">
        ...
        <div className="flex flex-wrap gap-4.5">
          {tuiles.map((t, i) => (
            <Reveal key={t.label} delay={i * 60} className={["group min-w-[240px]", t.classe].join(" ")}>
              <Link
                href="/galerie"
              ...
              >
                <Photo label={"photo — " + t.label} className="absolute inset-0" zoom />
