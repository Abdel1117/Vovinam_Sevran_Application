  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4.5">
        ...
        <label className="flex flex-col gap-2">
          <span className="flex items-baseline justify-between gap-3">
            ...
            <Link
              href="#"
              className="text-[0.84rem] font-semibold text-vovinam"
            >
              Mot de passe oublié ?
            </Link>
          </span>
        ...
        <label className="flex cursor-pointer items-center gap-3">
          ...
          />
          <span className="text-[0.94rem] text-encre-50">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full cursor-pointer rounded-full bg-vovinam px-6 py-4.5 text-base font-bold text-white transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgb(24_81_217/0.3)] disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0 disabled:hover:shadow-none"
        >
          {loading ? "Connexion en cours…" : "Se connecter"}
        </button>

        {erreur ? (
          <span className="flex items-center gap-2.5 rounded-field border border-[#f5c2c2] bg-[#fbebeb] px-4 py-3.5 text-[0.93rem] font-semibold text-[#a12626]">
            <span className="size-1.5 flex-none rounded-full bg-[#a12626]" />
            {erreur}
          </span>
        ) : null}
        ...
        <span className="my-0.5 flex items-center gap-3.5">
          ...
          <span className="text-[0.78rem] font-semibold tracking-[0.14em] text-encre-30 uppercase">
            ou
          </span>
          <span className="h-px flex-1 bg-trait" />
        </span>
      ...
      <div className="mt-7 flex flex-wrap items-center justify-between gap-3 border-t border-[#eff3fb] pt-5.5">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-[0.88rem] font-semibold text-[#6a7392] hover:text-vovinam"
        >
          ← Retour au site
        </Link>
        <Link
          href="#"
          className="text-[0.84rem] text-encre-30 hover:text-vovinam"
        >
