        ...
        actions={
          <>
            ...
            <Link
              ...
              className="inline-flex h-11.5 cursor-pointer itemsz-center gap-2 rounded-xl bg-vovinam px-5 text-[0.92rem] font-bold text-white transition-all hover:-translate-y-0.5"
            >
              + Nouvel adhérent
            </Link>
          </>
          ...
          {isLoading
            ? Array.from({ length: 3 }, (_, index) => (
                <div
                  ...
                  className={[
                    "flex min-w-[190px] flex-1 flex-col gap-3 p-5.5",
                    carte,
                  ].join(" ")}
                >
